...
manuscript against, and they are left in place deliberately. This script's
sound-input result is archived instead, under
...
-1.00, so adopting it is a decision about what the manuscript claims and not a
re-run. Running this
...
CELL_SOURCES = {
    ...
    # Damaged, and kept anyway: see the note on neutrophils in the docstring.
    "Neutrophils": CELL_TYPE_H5AD["Neutrophils"],
