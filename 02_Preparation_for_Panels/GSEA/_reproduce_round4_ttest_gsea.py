...
"""
Reproduce Round_4 t-test GSEA radar data exactly.
...
# Round_4 data dir for Mast/Plasma (not in Round_5)
R4_DATA = Path("/path/to/Project_4_05232025/Round_4"
               "/01_Round_4.2_Standardized_Pipeline/01_For_Annotation/02_Results/level_1")
...
def main():
    print("=" * 60)
    print("Reproducing Round_4 t-test GSEA (NR vs R, 100 perms)")
    print("=" * 60)
    ...
    # Compare with backup
    backup_csv = Path("/path/to/Project_4_05232025/Round_4"
