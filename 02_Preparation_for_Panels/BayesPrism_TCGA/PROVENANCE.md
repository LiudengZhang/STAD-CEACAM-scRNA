...
Source: `Round_5/98_Temp_workspace/02162026_BayesPrism`
...
reading live inputs out of `Round_5/98_Temp_workspace/02162026_BayesPrism`,
...
`Round_5/02_Preparation_for_Panels/BayesPrism_TCGA`, which already held two of
...
`find -L` over Round_4, Round_5 and Round_7 finds **zero** copies of all five
...
the clinical table through `Round_4/.../98_External/Bulk/02_TCGA_STAD`, a
symlink into `Round_5/01_Raw_Inputs/04_External`, and `04_External` was renamed
...
`import_pipelines.py`. Those are build directory letters. Rule 2 of `CLAUDE.md`:
