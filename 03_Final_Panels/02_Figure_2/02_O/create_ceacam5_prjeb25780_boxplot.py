#!/usr/bin/env python3
"""
Panel 2M: CEACAM5 boxplot from PRJEB25780 (BayesPrism epithelial-deconvolved)
...
def main():
    ...
    # Labels
    ax.set_title(r'$\it{CEACAM5}$ (Epi)', fontsize=5, pad=2)
    ...
    for ext in ['svg', 'png', 'pdf']:
        out = OUTPUT_DIR / f"ceacam5_prjeb25780_boxplot.{ext}"
