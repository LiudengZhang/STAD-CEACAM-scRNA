...
def main():
    ...
    # are wider than the plotting box, and a title wider than the box it is
    # centred on cannot be fitted: narrowing the box by a millimetre moves the
    # title's edge by half of one.
