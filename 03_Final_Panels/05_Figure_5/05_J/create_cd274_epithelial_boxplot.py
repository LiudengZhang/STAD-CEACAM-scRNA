#!/usr/bin/env python3
"""
Figure 5 panel J, box 2 of four - CD274 (PD-L1) expression in epithelial cells,
...
the four boxes together.
  ...
  printed panel  Figure 5 J, box 2   (PROVENANCE.csv - the directory is
                                   "05_J"; do NOT read the directory as
                                   the letter)
...
def main():
    ...
    ax.set_title('Epi', pad=style.tick_pt())
