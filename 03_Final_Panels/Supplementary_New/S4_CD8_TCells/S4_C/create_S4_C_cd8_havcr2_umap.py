#!/usr/bin/env python3
"""
S3 panel C - the stomach CD8+ T-cell UMAP coloured by HAVCR2 (TIM-3)
expression, drawn at the size it prints at.

  printed panel  Supplementary Figure S4 C   (PROVENANCE.csv)
  predecessor    submission-tree/03_Final_Panels/10_Supplementaries/S3_CD8_TCells/
                 S4_C/create_S3_C_cd8_havcr2_umap.py  (sc.pl.umap on an 8 x 7 cm
                 canvas at 4x)
...
FIG, PANEL = "S4_CD8_TCells", "S4_C"
GENE, TITLE, CMAP, VMIN = 'HAVCR2', 'HAVCR2 (TIM-3) expression', 'Reds', 0
