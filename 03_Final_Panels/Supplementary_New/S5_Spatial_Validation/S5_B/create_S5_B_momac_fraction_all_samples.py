#!/usr/bin/env python3
"""
S4 panel B - the ten GSE251950 sections coloured by Monocytes/Macrophages, drawn at the
size they print at.

  printed panel  Supplementary Figure S5 B   (PROVENANCE.csv)
  predecessor    submission-tree/03_Final_Panels/10_Supplementaries/S4_Spatial_Validation/
                 S5_B/create_S4_B_momac_fraction_all_samples.py
...
FIG, PANEL = "S5_Spatial_Validation", "S5_B"
COLUMN, CMAP, CBAR_LABEL = 'Monocytes/Macrophages', 'YlOrRd', 'Monocytes/Macrophages\nfraction'
