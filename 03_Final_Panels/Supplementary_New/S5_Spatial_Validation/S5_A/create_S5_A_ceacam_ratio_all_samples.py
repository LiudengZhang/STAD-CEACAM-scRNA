#!/usr/bin/env python3
"""
S4 panel A - the ten GSE251950 sections coloured by CEACAM_ratio, drawn at the
size they print at.

  printed panel  Supplementary Figure S5 A   (PROVENANCE.csv)
  predecessor    submission-tree/03_Final_Panels/10_Supplementaries/S4_Spatial_Validation/
                 S5_A/create_S4_A_ceacam_ratio_all_samples.py
...
FIG, PANEL = "S5_Spatial_Validation", "S5_A"
COLUMN, CMAP, CBAR_LABEL = 'CEACAM_ratio', 'RdBu_r', 'CEACAM ratio\n(high/total epi)'
