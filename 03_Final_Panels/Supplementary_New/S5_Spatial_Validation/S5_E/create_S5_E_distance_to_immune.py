#!/usr/bin/env python3
"""
S4 panel E - the ten GSE251950 sections coloured by distance_to_immune, drawn at the
size they print at.

  printed panel  Supplementary Figure S5 E   (PROVENANCE.csv)
  predecessor    submission-tree/03_Final_Panels/10_Supplementaries/S4_Spatial_Validation/
                 S5_E/create_S4_E_distance_to_immune.py
...
FIG, PANEL = "S5_Spatial_Validation", "S5_E"
COLUMN, CMAP, CBAR_LABEL = 'distance_to_immune', 'magma_r', 'Distance to\nimmune'
