#!/usr/bin/env python3
"""
S4 panel D - the ten GSE251950 sections coloured by distance_to_stroma, drawn at the
size they print at.

  printed panel  Supplementary Figure S5 D   (PROVENANCE.csv)
  predecessor    submission-tree/03_Final_Panels/10_Supplementaries/S4_Spatial_Validation/
                 S5_D/create_S4_D_distance_to_stroma.py
...
FIG, PANEL = "S5_Spatial_Validation", "S5_D"
COLUMN, CMAP, CBAR_LABEL = 'distance_to_stroma', 'viridis_r', 'Distance to\nstroma'
