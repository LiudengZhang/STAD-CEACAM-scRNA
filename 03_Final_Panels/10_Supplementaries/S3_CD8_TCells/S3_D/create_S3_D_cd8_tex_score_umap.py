#!/usr/bin/env python3
"""
S3_D: CD8+ T cell UMAP colored by Tex exhaustion score.
Uses sc.tl.score_genes with canonical Tex gene set. Stomach samples only.
"""
import sys
...
OUTPUT_PNG = OUTPUT_DIR / "panel_S3_D.png"

# Canonical Tex exhaustion gene signature
TEX_GENES = [
...
print(f"Tex genes available: {len(available)}/{len(TEX_GENES)}: {available}")
