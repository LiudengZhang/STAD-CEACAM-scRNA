#!/usr/bin/env python3
"""
S4_B: MoMac fraction spatial maps for all 10 GSE251950 samples.
...
def main():
    print("S4_B: MoMac Fraction Spatial Maps (All 10 Samples)")
    ...
    momac_col = 'Monocytes/Macrophages'
    ...
    vmin = df[momac_col].quantile(0.02)
    vmax = df[momac_col].quantile(0.98)
    ...
    cbar.set_label('Monocytes/Macrophages\nfraction', fontsize=5 * SCALE)
