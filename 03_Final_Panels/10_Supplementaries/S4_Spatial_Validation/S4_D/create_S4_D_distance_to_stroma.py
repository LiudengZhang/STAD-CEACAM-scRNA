#!/usr/bin/env python3
"""
S4_D: Distance to stroma spatial maps for all 10 GSE251950 samples.
...
def main():
    print("S4_D: Distance to Stroma Spatial Maps (All 10 Samples)")
    ...
    vmin = df['distance_to_stroma'].quantile(0.02)
    vmax = df['distance_to_stroma'].quantile(0.98)
