...
"""
Figure 3 panel I - distance to stroma from CEACAM-high and CEACAM-low spots, paired within
section.
...
rather than typed, and the panel-letter corner is left clear for the assembler.
  ...
  printed panel  Figure 3 I       (PROVENANCE.csv; the directory name agrees,
...
THE UNIT ON THE Y AXIS
    Until 2026-09-10 this panel plotted the raw `distance_to_distance_to_stroma` column of
...
def main():
    print("=" * 60)
    print("Figure 3 panel I: distance to stroma")
    print("=" * 60)
    ...
    sample_data['distance_to_stroma'] = sample_data['distance_to_stroma'] * um_per_unit
