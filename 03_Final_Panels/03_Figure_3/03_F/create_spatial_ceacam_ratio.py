#!/usr/bin/env python3
"""
Panel C: Spatial CEACAM Ratio (single panel, sample_03)
...
def main():
    ...
    cbar.set_label('CEACAM Ratio', fontsize=7 * SCALE)
    cbar.ax.tick_params(labelsize=6 * SCALE, width=1.0, length=4)
    cbar.outline.set_linewidth(1.0)

    ax.set_title('CEACAM Ratio', fontsize=8 * SCALE, fontweight='normal')
    ...
    out = os.path.join(BASE_DIR, 'spatial_ceacam_ratio.png')
