#!/usr/bin/env python3
"""
Panel I: Spatial Distance to Immune (single panel, sample_03)
...
def main():
    ...
    cbar.set_label('Dist to Immune', fontsize=7 * SCALE)
    cbar.ax.tick_params(labelsize=6 * SCALE, width=1.0, length=4)
    cbar.outline.set_linewidth(1.0)

    ax.set_title('Distance to Immune', fontsize=8 * SCALE, fontweight='normal')
    ...
    out = os.path.join(BASE_DIR, 'spatial_dist_immune.png')
