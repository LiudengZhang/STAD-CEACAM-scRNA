...
SCORES_FILE = Path("/path/to/upstream-pipeline/01_standardized-pipeline/01.1_meta_program_epithelial/04_Activity_Scores/epithelial_with_mp_scores.h5ad")
OUTPUT_DIR = BASE_DIR / "03_Output" / "05_Figures"
UMAP_SOURCE = Path("/path/to/upstream-pipeline/04_Final_Panels/00_Set_Ups/00_Data/01_Major_Cell_Types/Epithelial_functionally_annotated.h5ad")
