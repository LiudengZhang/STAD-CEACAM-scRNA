...
# data through upstream-pipeline/.../98_External/Bulk/02_TCGA_STAD, which is a symlink
# to submission-tree/01_Raw_Inputs/04_External/Bulk/TCGA_STAD - a directory that no
...
TCGA_BASE = Path("/path/to/submission-tree/01_Raw_Inputs/02_External/Bulk/TCGA_STAD")
...
TIGER_BP = Path("/path/to/submission-tree/02_Preparation_for_Panels/BayesPrism")
