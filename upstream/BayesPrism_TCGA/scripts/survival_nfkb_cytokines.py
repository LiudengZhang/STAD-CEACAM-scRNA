...
# upstream-pipeline/.../98_External/Bulk/02_TCGA_STAD, a symlink into
# submission-tree/01_Raw_Inputs/04_External - and 04_External was renamed 02_External,
...
TCGA_BASE = '/path/to/submission-tree/01_Raw_Inputs/02_External/Bulk/TCGA_STAD'

# Migrated 2026-09-03 on the author's ruling. Input and output used to be one
# directory, submission-tree/temp-workspace/02162026_BayesPrism, a temp workspace
