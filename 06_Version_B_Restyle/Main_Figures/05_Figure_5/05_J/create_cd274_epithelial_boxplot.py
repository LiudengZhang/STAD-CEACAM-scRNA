...
# Original one-tailed version: Round_5/03_Final_Panels/05_Figure_5/05_J/create_cd274_epithelial_boxplot.py
"""
Figure 5 panel J (one of four), RESTYLED (Version B) - CD274 Post-R vs Post-NR
in Epithelial cells.

Version A is
`03_Revised_Panels/Main_Figures/05_Figure_5/05_J/create_cd274_epithelial_boxplot.py`
...
string is Version A's. `np.random.seed(0)` stays exactly where Version A put it.
  ...
  printed panel  Figure 5 J        (PROVENANCE.csv; NOT inferred from "05_J")
