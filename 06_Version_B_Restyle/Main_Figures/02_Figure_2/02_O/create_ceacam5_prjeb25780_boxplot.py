...
# Original one-tailed version: Round_5/03_Final_Panels/02_Figure_2/02_O/create_ceacam5_prjeb25780_boxplot.py
"""
Figure 2, printed panel L (CEACAM5 half), RESTYLED (Version B) - PRJEB25780
BayesPrism epithelial-deconvolved expression, R versus NR.

Version A is
`03_Revised_Panels/Main_Figures/02_Figure_2/02_O/create_ceacam5_prjeb25780_boxplot.py`
...
The drawing code is the same code.
  ...
  printed panel  Figure 2 L     (PROVENANCE.csv; NOT inferred from "02_O")
                 Printed L is ONE letter over TWO drawings: 02_N (CEACAM6) and
                 02_O (CEACAM5, this file). They stay two files, as in
                 Version A.
  printed rect   68.3 x 20.4 mm for the pair (panel_rects.csv), so roughly
                 34 x 20.4 mm for this drawing alone
  Version B box  40.0 x 38.0 mm   (matched to 02_N, its other half)
