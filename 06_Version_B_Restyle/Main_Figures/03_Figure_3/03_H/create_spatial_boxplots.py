...
# Original one-tailed version: Round_5/03_Final_Panels/03_Figure_3/03_H/create_spatial_boxplots.py
"""
Figure 3 panel H, RESTYLED (Version B) - neighbourhood epithelial proportion, CEACAM-high vs
CEACAM-low, paired within section.

NOTE THE PANEL LETTER, AND THE FILENAME. This directory is `03_H` and
PROVENANCE.csv says it holds printed panel **H** (CLAUDE.md rule 2: the
...
Version A is
`03_Revised_Panels/Main_Figures/03_Figure_3/03_H/create_spatial_boxplots.py`
...
`y_max_limit=1.0` and the bracket geometry are untouched.

  printed panel  Figure 3 H     (PROVENANCE.csv; NOT inferred from "03_H")
  printed rect   30.8 x 31.9 mm   (panel_rects.csv)
...
MARK
    ...
    That corner note is also why the box is 52.0 mm wide and not 30.8: at 7 pt
...
PRINTED_MM = (30.8, 31.9)          # published rect, panel_rects.csv
